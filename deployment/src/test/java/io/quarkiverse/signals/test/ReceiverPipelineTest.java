...
public class ReceiverPipelineTest {
    ...
    public void testPipeline() {
        ...
        ShipmentConfirmation confirmation = placeOrder.request(new PlaceOrder("ORD-1", "Widget", 3),
    ...
    public void testPipelineMultipleOrders() {
        ShipmentConfirmation c1 = placeOrder
                .request(new PlaceOrder("A", "Gadget", 2), ShipmentConfirmation.class)
                .ifNoItem().after(Duration.ofSeconds(5)).fail()
                .await().indefinitely();
        ShipmentConfirmation c2 = placeOrder
                .request(new PlaceOrder("B", "Gizmo", 5), ShipmentConfirmation.class)
                .ifNoItem().after(Duration.ofSeconds(5)).fail()
                .await().indefinitely();
    ...
    public static class ValidationReceiver {
        ...
        ShipmentConfirmation onPlaceOrder(@Receives PlaceOrder order) {
            ...
            return validatedOrder.requestAndAwait(
